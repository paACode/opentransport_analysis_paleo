...
## Overview of Data
In order to obtain a overview of the obtained data, the following table was created.
```{r Overview Table eval=TRUE, echo=FALSE, include=TRUE, message=FALSE}
library(dplyr)
library(gt)
...
overview_delay_table %>%
  gt() %>%
  tab_header(
    title = "Summary of Train Delays by Weekday",
  ...
  cols_label(
    ...
    avg_delay_seconds = "Average Delay (seconds)",
    total_trains = "Total Trains",
    percentage_delayed_trains = "Percentage Delayed (%)"
  )
```
